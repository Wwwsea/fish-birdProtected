...
<template>
  <div class="bg">
    <div>
      <div class="title">
        <div>反馈区域</div>
        <el-button type="primary" plain @click="isShow = true">反馈</el-button>
      </div>
      <el-divider/>
      <div class="title_content">
        <span>欢迎访问反馈区域板块！</span>
        <span>反馈区域是一个方便与其他用户交流、分享观点和意见的平台。通过反馈区域，您可以：</span>
        <span>1、留下自己的反馈：无论是对特定主题的讨论、对某篇文章的评论，还是向其他用户提问，您都可以在反馈区域上发表自己的反馈。</span>
        <span>2、回复其他用户：看到其他用户的反馈后，您可以进行回复和互动，分享自己的观点，提供帮助或者表达共鸣。</span>
        <span>3、进行在线交流：反馈区域不仅是一个反馈的平台，还是一个与其他用户进行实时交流的地方。您可以通过反馈区域与他人进行私聊，分享更多的讨论和信息。</span>
