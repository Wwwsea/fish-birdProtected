    ...
    <div>
      <div class="other_login">
        <div style="margin-left: 1rem">
          <el-link href="http://127.0.0.1:8080/oauth/github/render">
          <svg-icon name="tencent-qq" width="20px" height="20px" color="#4E86F1"/>
          </el-link>
        </div>&nbsp&nbsp&nbsp&nbsp
        <div>
          <el-link href="http://127.0.0.1:8080/oauth/gitee/render">
