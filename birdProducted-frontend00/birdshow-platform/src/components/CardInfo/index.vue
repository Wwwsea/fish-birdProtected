...
<template>
  <div id="xxxxxx"></div>
  <!-- 
  <div class="info_container" :style="`background-image: url(${useWebsite.webInfo?.webmasterProfileBackground})`" v-slide-in>
    <div>
    ...
    <div class="icon">
      <a :href="useWebsite.webInfo?.githubLink">
        <div>
          <SvgIcon name="tencent-qq" width="20px" height="20px"/>
        </div>
      </a>
