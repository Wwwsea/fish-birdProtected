...
import { deleteLeaveMessage, isCheckLeaveMessage, leaveMessageList, searchLeaveMessage } from '~/api/bird/leave-word'
  ...
  >
    <template #form-items>
      <a-form-item label="用户名称" name="userName" style="margin-right: 1rem">
        <a-input v-model:value="formData.userName" placeholder="输入反馈用户" style="width: 15em" />
      </a-form-item>
    ...
    <template #operate-btn>
      ...
      <a-modal v-model:open="contentModel.show" width="700px">
        <template #title>
          <span style="color: #1677FF"><MessageOutlined /></span><span style="margin-left: 0.2rem">查看反馈</span>
        </template>
        <template #footer>
