...
import { chatGptList, deleteChatGpt, isCheckChatGpt, searchChatGpt } from '~/api/bird/chat-gpt'
          ...
          <template #renderItem="{ item }">
            <a-list-item>
              ...
              >
                ...
                <template #avatar>
                  <a-avatar :src="item.type === 'question' ? contentModel.avatar : `${DomainName}bird/gpt/chatgpt-de79290a.png`" />
                </template>
              </a-list-item-meta>
            </a-list-item>
          </template>
