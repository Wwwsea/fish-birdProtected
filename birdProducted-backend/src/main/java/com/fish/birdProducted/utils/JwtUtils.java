...
import com.fish.birdProducted.constants.SecurityConst;
...
//                .withClaim("authorities", details.getAuthorities().stream().map(GrantedAuthority::getAuthority).toList())
    ...
    public Date expireTime() {
        ...
        calendar.add(Calendar.HOUR, expire * 24); // 默认令牌过期时间24小时
    ...
    private String convertToken(String headerToken) {
        // Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJuYW1lIjoic2VhZmxvd3MiLCJpZCI6MTQxNjQzODYsImV4cCI6MTcxMDkxMTk0OCwiaWF0IjoxNzEwMzA3MTQ4LCJqdGkiOiI1NDZiNjlmMi1iMmQ4LTRkYWEtOGE5Mi1hODA0NmEzZDY1MTYifQ.Y-LHngY2UK64PrICGeIaKOLn5onxsbCIY-beH2BIj08
